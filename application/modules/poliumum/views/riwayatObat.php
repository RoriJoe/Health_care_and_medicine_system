                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $url= 'showTrans';
                                        if($this->uri->segment(4, 0)=='minta'){
                                            $url= 'showTransPermintaan';
                                        }
                                        ?>
                                        <button class="btn btn-primary pull-left"  onclick="location.href ='<?= base_url().$this->uri->segment(1, 0).'/'.$this->uri->segment(2, 0).'/'.$url.'/'.$dataTrans[$i]['ID_TRANSAKSI']  ?>';" >Detail</button>
                                    </td>
                                </tr>
                                <?php endfor; ?>
                            </tbody>
