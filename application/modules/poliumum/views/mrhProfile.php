...
<form method="post" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2); ?>/updateAllEntryRRM">
...
<?php foreach ($riwayat_rm[0] as $key => $value) :  ?>
	...
	<?php if ($key != "ID_RIWAYAT_RM" && $key != "ID_REKAMMEDIK" && $key != "FLAG_HAMIL" && $key != "ID_LAYANAN_KES" && $key != "ID_SUMBER" && $key != "STAT_RAWAT_JALAN" && $key !="FLAG_OPNAME" && $key !="TANGGAL_RIWAYAT_RM") :  ?>
