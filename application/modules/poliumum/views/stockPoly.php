...
{
	$('#results').html('');
	$('#results').append('<div class="alert alert-info">Memuat Daftar Stok Obat Poli Umum...</div>');
	...
	$.ajax({
		...
		success: function (dataCheck) {
			if (dataCheck.length > 0) {
				...
				$('#results').html('');
				$('#results').append('<div class="alert alert-success">Daftar Stok Obat Poli Umum Kosong!</div>');
			}
		},
