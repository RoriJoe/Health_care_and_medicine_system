        ...
        <div class="col-md-8">
            ...
            <div>                            
				...
				<div class="col-md-6">
                    ...
                    <div id="detail_riwayat" class="" hidden="hidden">
                        ...
                        <form id="FormHomePoliumum" method="post" action="<?php echo base_url() .$this->uri->segment(1).'/'.$this->uri->segment(2).'/updateRMHistory'; ?>">
                            <input id="id_rrm" name="id_rrm" hidden="hidden">							
                                ...
                                <div class="col-md-3 form-group">
									...
									<input autofocus class="form-control" id="tinggi" name="tinggi" placeholder="dalam Centimeter" type="number" min="0">
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <input type="hidden" id="hidden_noantrian" name="hidden_noantrian" value="">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
				...
				<div id="subunit3">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control datepicker2" id="tanggalAntrian2" name="tanggalAntrian2" placeholder="Masukkan Tanggal Kunjungan" value="<?php echo date('d-m-Y'); ?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Waktu Antrian</label>
                                        <input class="form-control" name="waktuAntrian2" type="text" value="<?php
                                        $time = date('H:i:s');
                                        echo $time
			...
			<div class="modal-body">
				...
				<div id="subunit4">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        <label>Tanggal Kunjungan</label>
                                        <input class="form-control datepicker" id="tanggalAntrian" name="tanggalAntrian" placeholder="Masukkan Tanggal Kunjungan" value="<?php echo date('d-m-Y'); ?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Waktu Antrian</label>
