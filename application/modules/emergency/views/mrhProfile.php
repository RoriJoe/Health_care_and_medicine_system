    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <?php if (!empty($dataUgd)) : ?>
                <hr/>
                <h3>Riwayat UGD</h3>
                <table class="table table-bordered table-striped table-comparison table-responsive">
                    <?php 
                        foreach ($dataUgd[0] as $key => $value) :
                            if(!empty($value) && $key!='ID_RIWAYAT_RM' && $key!='ID_DATA_UGD'){
                                $key= strtoupper($key);
                                $key= str_replace("UGD_", "", $key);
                                if($key=='JENIS_LAKALANTAS'){
                                    if($value=='1') $value="Luka Ringan";
                                    else if($value=='2') $value="Luka Berat";
                                    else if($value=='3') $value="Mati";
                                }
                                else 
                                    if($value=="1") $value="Ya";
                    ?>
