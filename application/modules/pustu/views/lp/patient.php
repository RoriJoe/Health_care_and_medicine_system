    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-body"> &nbsp;
                ...
                <div class="col-md-12">
                    <form method="post" id="FormDaftarPasien" action="<?php echo base_url(); ?>pustu/lp/newRegistration">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly class="form-control" id="noKesehatanPasien" placeholder="Masukkan Nomor Index Pasien" name="noKesehatanPasien" type="text" value="<?php if (isset($nomor_index)) echo $nomor_index;?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
function setKelurahan (value) {
	...
	$.ajax({
		...
		url: '<?php echo base_url(); ?>pustu/lp/setKecamatan',
