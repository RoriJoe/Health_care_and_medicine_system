...
<div class="col-lg-6">
      ...
      <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="<?php echo base_url(); ?>index.php/admHc/scAdmHc/addSCategory">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Nama Kategori Layanan</label>
                        <div class="col-sm-6">
                            <input type="text" id="inputNamaKategoriLayanan" name="inputNamaKategoriLayanan" class="form-control">
                        </div>
                    </div>
