			...
			<div class="panel-body">
				<div class="col-lg-6">
					<div class="panel panel-primary">
						...
						<section class="panel">
							<div class="panel-body">
								<form class="form-horizontal bucket-form"  method="post" action="<?php echo base_url().'index.php/HClinic/'.$this->uri->segment(2, 0).'/saveUpdateKGFK' ?>">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Kepala Gudang Farmasi Kabupaten</label>
										<div class="col-sm-9">
											<select class="form-control m-bot15" id="inputKGFK" name="inputKGFK">
												<option value=''>Tidak Ada</option>
												<?php
													if(isset($KGFK[0]['ID_AKUN']))
													echo '<option selected value="'.$KGFK[0]['ID_AKUN'].'">'.$KGFK[0]['NAMA_AKUN'].'</option>';
