			...
			<div class="panel-body">
				<div class="col-lg-6">
					<div class="panel panel-primary">
						...
						<section class="panel">
							<div class="panel-body">
								<form class="form-horizontal bucket-form"  method="post" action="<?php echo base_url().'index.php/HClinic/'.$this->uri->segment(2, 0).'/saveUpdateDinas' ?>">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Kepala Dinas</label>
										<div class="col-sm-9">
											<select class="form-control m-bot15" id="inputKDinas" name="inputKDinas">
												<option value=''>Tidak Ada</option>
												<?php
													if(isset($KDinas[0]['ID_AKUN']))
													echo '<option selected value="'.$KDinas[0]['ID_AKUN'].'">'.$KDinas[0]['NAMA_AKUN'].'</option>';
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Admin Dinas</label>
										<div class="col-sm-9">
											<select class="form-control m-bot15" id="inputSIK" name="inputSIK">
													<option value=''>Tidak Ada</option>
												<?php
													if(isset($SIK[0]['ID_AKUN']))
													echo '<option selected value="'.$SIK[0]['ID_AKUN'].'">'.$SIK[0]['NAMA_AKUN'].'</option>';
													foreach($allAvailableAcc as $avacc)
													{
														echo '<option value="'.$avacc['ID_AKUN'].'">'.$avacc['NAMA_AKUN'].'</option>';
													}
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Kabid Yankes</label>
										<div class="col-sm-9">
											<select class="form-control m-bot15" id="inputKYankes" name="inputKYankes">
													<option value=''>Tidak Ada</option>
												<?php
													if(isset($KYankes[0]['ID_AKUN']))
													echo '<option selected value="'.$KYankes[0]['ID_AKUN'].'">'.$KYankes[0]['NAMA_AKUN'].'</option>';
													foreach($allAvailableAcc as $avacc)
													{
														echo '<option value="'.$avacc['ID_AKUN'].'">'.$avacc['NAMA_AKUN'].'</option>';
													}
