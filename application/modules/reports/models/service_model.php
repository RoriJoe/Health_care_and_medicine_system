...
class Service_model extends CI_Model {
	...
	function getkk ($idPuskesmas='',$month='', $year='') {
		$sql = 'CALL puskesmas_kk('.$idPuskesmas.','.$month.','.$year.')';
	...
	function getpvisit ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_visit('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getgigiumum ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_gigiumum('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getsourcekunjungan($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_sourceservice('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getkasus ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_kasus('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getservice ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_service('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getrjalan ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL rjalan_visit('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getsourceservice ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_sourceservice('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
	...
	function getSP ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_bysourcepayment('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
	...
	function getugd ($idPuskesmas='',$month='', $year='') {
		$query = $this->db->query('CALL puskesmas_ugd('.$idPuskesmas.','.$month.','.$year.')');
		$hasil = $query->result_array();
		$this->db->close();
		//print_r ($hasil);
		if ($query->num_rows> 0) return $hasil; 
