...
class mQueue extends CI_Model {
	...
	function getAllByUnit ($id_unit) {	
		$sql = "select au.id_antrian_unit, au.id_riwayat_rm, p.nama_pasien, au.waktu_antrian_unit, au.flag_intern from antrian_unit au left join riwayat_rm rrm on au.id_riwayat_rm = rrm.id_riwayat_rm
