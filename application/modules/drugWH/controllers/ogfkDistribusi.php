...
class OgfkDistribusi extends ogfkDistribusiController {
    ...
    function index() {
		redirect (base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/listDrugsOut');
    }
	...
	public function addDrugsDetailOK () {
		...
		// pamol 1, pamol 2
		// haystack : ()		
		// hy baru : pamol 1 pamol 2
		
		// goleki amok
		// amok 1 - 3
		// haystack : pamol 1, pamol
		// hy baru : pamol 1, pamol 2
		// hy baru : pamol 1 , pamol 2, amok 1 - 3
		
		// goleki pamol
		// pamol 1 - 3
		// hystak : pamol 1 , pamol 2, amok 1 - 3
		// hy baru: amok 1-3
		// hy baru: amok 1-3, pamol 1-3
	...
	function listDrugsOut () {		
		...
		$this->display('list_drugs_out_distribusi', $data);
	}
	...
	function showDetailRequestPerBatch () {
		$id = $this->input->post ('id');
		$result = $this->mDrugsDetailTrans->getEntryByIdPerBatch($id);
		if ($result) echo json_encode($result);
	}
	
	function setujuiDistribusi () {
		$id = $this->input->post('inputTransaksi');
		$data = array (
			'FLAG_KONFIRMASI' => 0
		);
		$this->mDrugsTransaction->updateEntry($id, $data);
		redirect (redirect (base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/listDrugsOut'));
	}
