...
<div class="col-md-9">
	...
	<section class="slice bg-2 p-15">
        <h3>Rekap Distribusi Obat</h3>
    </section>
	<br>
		<div class="row">
			<form id="FormRekapDO" name="FormRekapDO" method="post" action="">
			<div class="col-md-6">
				<div class="form-group">
					<label for="tanggalPertama" >Pilih Tanggal Transaksi I</label>
					<input required placeholder="Masukkan Tanggal Transaksi" class="form-control datepicker" id="tanggalPertama" name="tanggalPertama">
				</div>
			</div>
			<div class="col-md-6">
					<label for="tanggalKedua" >Pilih Tanggal Transaksi II</label>
					<div class="input-group">
					<input required placeholder="Masukkan Tanggal Transaksi" class="form-control datepicker" id="tanggalKedua" name="tanggalKedua">
		...
		<div class="row">
			<div class="col-md-6" style="height: 150px; overflow-y: scroll;">
				<table class="table table-striped table-comparison table-responsive">
					...
					<tbody id="puskesmasTerlibat1" name="puskesmasTerlibat1">  
			...
			<div class="col-md-6" style="height: 150px; overflow-y: scroll;">
				<table class="table table-striped table-comparison table-responsive">
					...
					<tbody id="puskesmasTerlibat2" name="puskesmasTerlibat2">  
						<tr><td colspan=3><center>Kosong<center></td></tr>
					</tbody>
				</table>
			</div>
		...
		<div class="row">
			<div class="col-md-12" style="height: 400px; overflow-y: scroll;">
				...
				<tbody id="puskesmasTotal" name="puskesmasTotal">  
					<tr><td colspan=5><center>Kosong<center></td></tr>
				</tbody>
			</table>
			</div>
		</div>
	...
	$.ajax({
		...
		success: function(response){  		
			...
			$.each(objData, function(index, value) { 
				...
				content += '<td><a id="linknya" type="button" class="btn btn-xs btn-warning" style="color: white" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2); ?>/showDetailDO/'+value.ID_UNIT+'/'+date+'/'+value.NAMA_GEDUNG+'" target="_blank"><i class="fa fa-search"></i></a></td></tr>';
			});			
			}
			else {
