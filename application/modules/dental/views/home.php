    ...
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Antrian Poli Gigi</h3>
                </div>
                            ...
                            <tbody>								 
                                <?php if (isset($queues)) : ?>
                                    ...
                                    foreach ($queues as $row) : ?>
                                        <tr style="background-color: <?php if ($row['flag_intern'] == '0') echo '#C3FFB5';
                                        else echo 'yellow'; ?>" id="row<?php echo $row['id_antrian_unit']; ?>">
        ...
        <div class="col-md-8">
            <section class="slice bg-2 p-15">
                <h3>Kunjungan Pasien Poli Gigi</h3>
            </section>	
            <div>                            
                <div class="row">	
                    <br>
