                ...
                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn <?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'btn-primary':'btn-danger' ?> pull-left"  onclick="location.href ='<?= base_url().$this->uri->segment(1, 0).'/'.$this->uri->segment(2, 0).'/obatMasuk/retur/'.$pengiriman[$i]['ID_TRANSAKSI'].'/'.$pengiriman[$i]['TRANSAKSI_UNIT_DARI'] ?>';" <?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'disabled':'' ?>><?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'Terkirim':'Pending' ?></button>
                            </td>
                        </tr>
                        <?php endfor; ?>
                    </tbody>
