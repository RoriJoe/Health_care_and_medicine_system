    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php }else if($this->uri->segment(4, 0)=='permintaan_poli'){ ?>
                <button class="btn btn-primary pull-left"  onclick="location.href ='<?= base_url().$this->uri->segment(1, 0).'/'.$this->uri->segment(2, 0).'/obatKeluar/newPoli' ?>';">Pengiriman Baru</button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php }else if($this->uri->segment(4, 0)=='permintaan_poli'){ ?>
                                <button class="btn <?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'btn-primary':'btn-danger' ?> pull-left"  onclick="location.href ='<?= base_url().$this->uri->segment(1, 0).'/'.$this->uri->segment(2, 0).'/obatKeluar/detail_poli/'.$permintaan[$i]['ID_TRANSAKSI'].'/'.$permintaan[$i]['TRANSAKSI_UNIT_DARI'] ?>';" <?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'disabled':'' ?>><?php echo (isset($flag[$i][0]['FLAG_KONFIRMASI']))?'Terkirim':'Pending' ?></button>
                                <?php }else if($this->uri->segment(4, 0)=='permintaan_pustu'){ ?>
