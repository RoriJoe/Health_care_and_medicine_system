                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                <input name="mulai" class="mulai datepicker form-control form-control-inline default-date-picker"  size="16" type="text" value="<?php if($this->uri->segment(5, 0)) echo $this->uri->segment(5, 0); else echo date('d-m-Y',strtotime("-2 week")); ?>" />
                            </div>
                        </div>
                    </div>
                    <br/>
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                <input name="hingga" class="hingga datepicker form-control form-control-inline default-date-picker"  size="16" type="text" value="<?php if($this->uri->segment(6, 0)) echo $this->uri->segment(6, 0); else echo date('d-m-Y'); ?>" />
                            </div>
                            <div class="col-sm-2">
