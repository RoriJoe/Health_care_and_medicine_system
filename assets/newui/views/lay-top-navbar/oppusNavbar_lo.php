        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown <?php echo ($fungsi == 'resepPasien') ? 'active' : ''; ?>">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?= base_url().$this->uri->segment(1, 0).'/lo/resepPasien/list' ?>">Daftar Permintaan Resep</a></li>
                    <li><a href="<?= base_url().$this->uri->segment(1, 0).'/lo/resepPasien/riwayatTebusan' ?>">Riwayat Resep</a></li>
                </ul>
            </li>
            <li class="dropdown">
