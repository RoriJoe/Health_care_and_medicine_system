...
<head>
  ...
  <section id="container" class="hr-menu">
      ...
      <header class="header">
          ...
          <div class="navbar-header" style="background: #1fb5ad; padding-bottom: 10px; ">
...
<!--              <div class="brand ">
              ...
              <div class="horizontal-menu navbar-collapse collapse ">
                  <ul class="nav navbar-nav">
                      <li><h4 class="widget-h" style="color: white">Puskesmas Sumbersari - JL. Mayjen DI Panjaitan No. 42, Sumbersari, Jember</h4></li>
                  </ul>
              </div>
